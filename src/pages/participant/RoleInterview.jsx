    ...
    <div className="p-6">
      ...
      <fieldset ref={firstQuestionRef} disabled={!canEdit || (status === 'submitted' && !editing)} className="scroll-mt-6 space-y-5">
        ...
        {[
          ...
          ['Challenges', 'Share experiences from the last two years that you found challenging. This could include projects, assignments, situations, transitions, or interpersonal challenges. For each, describe what prompted the challenge and the obstacles you had to overcome.'],
