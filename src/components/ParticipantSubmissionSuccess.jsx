...
export default function ParticipantSubmissionSuccess({ stepName, nextTo, nextLabel, detail, children, heading = 'Successfully recorded', onEdit = null }) {
  return (
    <section className="rounded-xl border border-emerald-200 bg-emerald-50 p-6 text-center">
      ...
      <h2 className="mt-3 text-base font-semibold text-emerald-800">{heading}</h2>
      ...
      <div className="mt-5 flex flex-wrap justify-center gap-3">
        {onEdit && <button type="button" onClick={onEdit} className="rounded-lg border border-[#1e4d8c] bg-white px-4 py-2 text-sm font-semibold text-[#1e4d8c] hover:bg-blue-50">Edit Submission</button>}
