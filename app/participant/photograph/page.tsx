        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
          ...
          {preview && (
            <div className="mt-4 flex justify-center">
              ...
              <img src={preview} alt="Submitted photo" className="w-28 h-28 rounded-full object-cover border-4 border-green-200" />
            </div>
          )}
            ...
            {preview ? (
              <div className="flex flex-col items-center gap-4">
                ...
                <img
                  src={preview}
                  alt="Preview"
                  className="w-36 h-36 rounded-full object-cover border-4 border-[#dbeafe]"
                />
